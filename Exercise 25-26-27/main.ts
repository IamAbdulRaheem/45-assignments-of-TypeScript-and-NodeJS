...
let alienColorForIf: string= "Green";
...
let alienColorForElse: string= "Red";
...
let alienGreenVersion: string= "Green";
...
let alienYellowVersion: string= "Yellow";
...
let alienRedVersion: string= "Red";
